...
const signInWithMicrosoft = async () => {
  try {
    ...
    console.error('Erreur lors de la connexion avec Microsoft:', err)
    error.value = 'Erreur lors de la connexion avec Microsoft. Veuillez réessayer.'
  } finally {
    loading.value = false
  }
}
    ...
    <div class="login-card">
      ...
      <div class="button-group">
        ...
        <button
          ...
          :disabled="loading"
          class="login-button microsoft-button"
        >
